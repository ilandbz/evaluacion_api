                    ...
                    <div class="card-body">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <div class="row">
                                    <div class="col">
                                        <h4>POSTULANTE : {{ $alumno['apenom'] }} </h4>
                                    </div>
                                    <div class="col">
                                                        ...
                                                        @foreach ($alternativas as $alternativa)
                                                            <div class="mb-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="pregunta_marcacion[{{ $index + 1 }}][marcado]" id="alternativa{{$alternativa['id']}}" value="<?php echo $alternativa['text'] ?>">
